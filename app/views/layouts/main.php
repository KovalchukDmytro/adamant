            ...
            <div class="row">
                <div class="col-sm-4 text-left hidden-xs">
                    <div class="widget-contacts">
                        <a class="contacts-link"><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><?=$this->params['header-phone'] ?></a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <ul class="nav navbar-nav navbar-left">
                            <li class="menu-item">
                                <a class="menu-link" href="<?= Url::home() ?>"><?= $this->params['home-page'] ?></a>
                            </li>
                            <li class="menu-item dropdown">
                                ...
                                <ul class="dropdown-menu">
									...
									<?php foreach ( $models as $model ) : ?>
                                        <li>
                                            <a href="<?= Url::toRoute( '/services/' . $model->alias ) ?>"><?= $model->info->title ?></a>
                                        </li>
									<?php endforeach; ?>
                                </ul>
                            <li class="menu-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="footer-widget"><a class="footer-logo-link" href="<?= Url::home() ?>"><img
                                class="footer-logo"
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="footer-widget">
                    <nav class="footer-menu">
                        <a href="<?= Url::home() ?>" class="footer-menu-link"><?= $this->params['home-page'] ?></a>
                ...
                <div class="footer-widget">
                    <div class="feedback"><span
                        ...
                        <form id="form" name="form" method="post">
                            <input id="name" name="name" class="feedback-input" type="text"
                                   placeholder="<?= $this->params['name-form-placeholder'] ?>">
                            <input id="phone" name="phone" class="feedback-input" type="tel"
                                   placeholder="<?= $this->params['phone-number-form-placeholder'] ?>">
                            <button class="feedback-submit"
                                    type="submit"><?= $this->params['call-back-form'] ?>
                            </button>
                        </form>
                    </div>
                </div>
